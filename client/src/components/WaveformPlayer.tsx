...
export interface WaveformPlayerHandle {
  ...
  destroy: () => void;
  /** ── Phase F-2: Playback Control Methods ────────────────────────────────────── */
  /** Seek to specific time (in seconds). Clamps to valid duration. */
  seek: (time: number) => void;
  /** Start playback if not already playing. Safe if audio not ready. */
  play: () => void;
  /** Pause playback. Safe if audio not ready. */
  pause: () => void;
